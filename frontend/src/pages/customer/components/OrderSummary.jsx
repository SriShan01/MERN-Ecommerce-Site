                    ...
                    <List disablePadding>
                        <ListItem sx={{ py: 1, px: 0 }}>
                            ...
                            <Typography variant="subtitle1" sx={{ fontWeight: 700 }}>
                                {`₹${productDetailsCart.price && productDetailsCart.price * productDetailsCart.quantity}`}
                            </Typography>
                        </ListItem>
                        <ListItem sx={{ py: 1, px: 0 }}>
                            <ListItemText primary="Discount" />
                            <Typography variant="subtitle1" sx={{ color: "green" }}>
                                ₹{productDetailsCart.price && productDetailsCart.price - productDetailsCart.mrp}
                            </Typography>
                        </ListItem>
                        <ListItem sx={{ py: 1, px: 0 }}>
                        ...
                        <ListItem sx={{ py: 1, px: 0 }}>
                            ...
                            <Typography variant="subtitle1" sx={{ fontWeight: 700 }}>
                                ₹{productDetailsCart.price && productDetailsCart.mrp * productDetailsCart.quantity}
                            </Typography>
                        </ListItem>
                    </List>
