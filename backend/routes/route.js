...
const {
  ...
  searchProductRecommendationCategory,
...
router.get("/searchProductRecommendation/:key", searchProductRecommendation);
router.get("/searchProductRecommendationCategory/:key", searchProductRecommendationCategory);
